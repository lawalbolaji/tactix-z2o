...
export default defineSchema({
  ...
  applications: defineTable({
    ...
    score: v.optional(v.number()) /* to be assigned by evaluation engine */,
    rational: v.optional(v.string()) /* to be assigned by evaluation engine */,
    status: v.string(),
    linkedin: v.string(),
    portfolio: v.string(),
    salary: v.optional(v.number()),
    location: v.string(),
    years_of_experience: v.optional(v.number()) /* will be fixed by evaluation engine */,
